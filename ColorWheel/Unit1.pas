...
var
  Form1: TForm1;
  i:boolean;      //i показывает статус программы - вкл. или выкл.
  a,b,c,d,e,f:integer;   //  отвечают за количество перемещений отдельного кольца.
  implementation
...
begin
    //  вращаем самое большое кольцо против часовой
    if i=True then          // проверяем статус программы

    begin

    inc(b);

    if (b=1) or (b=-11) then  // следим за количеством нажатий на данную кнопку
                 //при достижении максимума нажатий(12), счётчик обнуляем
    begin
    ...
    // красный(1)->оранжевый(1)

    Image1.Canvas.Brush.Color:=RGB(255,89,0);
    Image1.Canvas.FloodFill(10+2+1+1*30,10+200-2-1,clWhite,fsBorder);

    // красный(2)->оранжевый(2)
    ...
    // синий(2)->фиолетовый(2)

    Image1.Canvas.Brush.Color:=RGB(194,0,97);
    Image1.Canvas.FloodFill(200+10-1-2,10+200+20+1+4*30,clWhite,fsBorder);

    // фиолетовый(1)->красный(1)

    Image1.Canvas.Brush.Color:=RGB(255,0,0);
    Image1.Canvas.FloodFill(10+40+2+1+1*30,400-80-1*30,clWhite,fsBorder);

    // фиолетовый(2)->красный(2)
    ...
    // оранжевый(1)-зелёный(1)

    Image1.Canvas.Brush.Color:=RGB(102,255,0);
    Image1.Canvas.FloodFill(10+200-2-1,10+2+1+1*30,clWhite,fsBorder);

    // оранжевый(2)-зелёный(2)
    ...
    // голубой-фиолетовый(1)

    Image1.Canvas.Brush.Color:=RGB(153,0,255);
    Image1.Canvas.FloodFill(200+2+1+4*30,200+2+1+4*30,clWhite,fsBorder);

    // синий(1)-фиолетовый(2)
   ...
   Image1.Canvas.FloodFill(200+10-1-2,10+200+20+1+4*30,clWhite,fsBorder);
    ...
    // фиолетовый(1)-красный(2)

    Image1.Canvas.Brush.Color:=RGB(255,25,51);
    Image1.Canvas.FloodFill(10+40+2+1+1*30,400-80-1*30,clWhite,fsBorder);

    // фиолетовый(2)-оранжевый(1)
    ...
    // зелёный(2)-фиолетовый(1)

    Image1.Canvas.Brush.Color:=RGB(153,0,255);
    Image1.Canvas.FloodFill(10+2+200+20+1+4*30,10+200+2+1,clWhite,fsBorder);

    // голубой-фиолетовый(2)
    ...
    // фиолетовый(1)-оранжевый(1)

    Image1.Canvas.Brush.Color:=RGB(255,89,0);
    Image1.Canvas.FloodFill(10+40+2+1+1*30,400-80-1*30,clWhite,fsBorder);

    // фиолетовый(2)-оранжевый(2)
   ...
   Image1.Canvas.FloodFill(10+200-2-1,10+2+1+1*30,clWhite,fsBorder);
    ...
    // зелёный(1)-фиолетовый(1)

    Image1.Canvas.Brush.Color:=RGB(153,0,255);
    Image1.Canvas.FloodFill(10+2+200+20+1+4*30,10+200-2-1,clWhite,fsBorder);

    // зелёный(2)-фиолетовый(2)
   ...
   Image1.Canvas.FloodFill(10+2+200+20+1,10+200+20+2+1+4*30,clWhite,fsBorder);
    ...
    // фиолетовый(1)-зелёный(1)

    Image1.Canvas.Brush.Color:=RGB(102,255,0);
    Image1.Canvas.FloodFill(10+40+2+1+1*30,400-80-1*30,clWhite,fsBorder);

    // фиолетовый(2)-зелёный(2)
    ...
    // оранжевый(1)-фиолетовый(1)

    Image1.Canvas.Brush.Color:=RGB(153,0,255);
   Image1.Canvas.FloodFill(10+200-2-1,10+2+1+1*30,clWhite,fsBorder);

    // оранжевый(2)-фиолетовый(2)
    ...
    // фиолетовый(1)-зелёный(2)

    Image1.Canvas.Brush.Color:=RGB(0,186,67);
    Image1.Canvas.FloodFill(10+40+2+1+1*30,400-80-1*30,clWhite,fsBorder);

    // фиолетовый(2)-голубой
   ...
   Image1.Canvas.FloodFill(10+2+1+1*30,10+200-2-1,clWhite,fsBorder);
    ...
    // красный(2)-фиолетовый(1)

    Image1.Canvas.Brush.Color:=RGB(153,0,255);
    Image1.Canvas.FloodFill(10+2+1+2*30,10+200-2-1-2*30-20,clWhite,fsBorder);

    // оранжевый(1)-фиолетовый(2)

    Image1.Canvas.Brush.Color:=RGB(194,0,97);
   Image1.Canvas.FloodFill(10+200-2-1,10+2+1+1*30,clWhite,fsBorder);

    // оранжевый(2)-красный(1)
    ...
    // зелёный(1)-оранжевый(1)

    Image1.Canvas.Brush.Color:=RGB(255,89,0);
   Image1.Canvas.FloodFill(10+2+200+20+1+4*30,10+200-2-1,clWhite,fsBorder);

    // зелёный(2)-оранжевый(2)
   ...
   Image1.Canvas.Brush.Color:=RGB(0,186,67);
    ...
    // фиолетовый(1)-голубой

    Image1.Canvas.Brush.Color:=RGB(0,179,217);
    Image1.Canvas.FloodFill(10+40+2+1+1*30,400-80-1*30,clWhite,fsBorder);

    // фиолетовый(2)-синий(1)
    ...
    // красный(1)-фиолетовый(1)

    Image1.Canvas.Brush.Color:=RGB(153,0,255);
    Image1.Canvas.FloodFill(10+2+1+1*30,10+200-2-1,clWhite,fsBorder);

    // красный(2)-фиолетовый(2)

    Image1.Canvas.Brush.Color:=RGB(194,0,97);
    Image1.Canvas.FloodFill(10+2+1+2*30,10+200-2-1-2*30-20,clWhite,fsBorder);

    // оранжевый(1)-красный(1)

    Image1.Canvas.Brush.Color:=RGB(255,0,0);
    Image1.Canvas.FloodFill(10+200-2-1,10+2+1+1*30,clWhite,fsBorder);

    // оранжевый(2)-красный(2)
   ...
   Image1.Canvas.Brush.Color:=RGB(102,255,0);
    ...
    // фиолетовый(1)-синий(1)

    Image1.Canvas.Brush.Color:=RGB(0,102,255);
    Image1.Canvas.FloodFill(10+40+2+1+1*30,400-80-1*30,clWhite,fsBorder);

    // фиолетовый(2)-синий(2)
    ...
    // оранжевый(1)-красный(2)

    Image1.Canvas.Brush.Color:=RGB(255,25,51);
    Image1.Canvas.FloodFill(10+200-2-1,10+2+1+1*30,clWhite,fsBorder);

    // оранжевый(2)-оранжевый(1)
   ...
   Image1.Canvas.Brush.Color:=RGB(0,179,217);
    ...
    // фиолетовый(1)-синий(2)

     Image1.Canvas.Brush.Color:=RGB(0,25,255);
    Image1.Canvas.FloodFill(10+40+2+1+1*30,400-80-1*30,clWhite,fsBorder);

    // фиолетовый(2)-фиолетовый(1)
...
begin
    //  вращаем третье по величине кольцо против часовой
    if i=True then          // проверяем статус программы
    ...
    if (c=11) or (c=-1) then  // следим за количеством нажатий на данную кнопку
                 //при достижении максимума нажатий(12), счётчик обнуляем
    begin
...
begin
    //  вращаем третье по величине кольцо по часовой
    if i=True then          // проверяем статус программы
...
begin
    //  вращаем четвёртое по величине кольцо по часовой
    if i=True then          // проверяем статус программы
    ...
    if (d=11) or (d=-1) then  // следим за количеством нажатий на данную кнопку
                 //при достижении максимума нажатий(12), счётчик обнуляем
    begin
...
begin
    //  вращаем четвёртое по величине кольцо против часовой
    if i=True then          // проверяем статус программы
...
begin
    //  вращаем пятое по величине кольцо по часовой
    if i=True then          // проверяем статус программы
    ...
    if (e=11) or (e=-1) then  // следим за количеством нажатий на данную кнопку
                 //при достижении максимума нажатий(12), счётчик обнуляем
    begin
...
begin
    //  вращаем пятое по величине кольцо против часовой
    if i=True then          // проверяем статус программы
...
begin
    ...
    //закрашиваем фон Image1 в чёрный

    Image1.Canvas.Pen.Color:=clBlack;
    Image1.Canvas.Brush.Color:=clBlack;
    Image1.Canvas.FillRect(rect(0,0,420,420));

    //рисуем основу - секторы
    ...
    //закрашиваем центральную область белым
    ...
    //закрашиваем каждый сектор своим цветом
    // нумерация от края (в центре сектор с номером 6)
    //         красный(1)
    {1}
...
begin
    ...
    if (a=1) or (a=-11) then  // следим за количеством нажатий на данную кнопку
                 //при достижении максимума нажатий(12), счётчик обнуляем
    begin
...
begin
 //  вращаем самое большое кольцо по часовой
    if i=True then          // проверяем статус программы
...
begin
  //  вращаем второе по величине кольцо по часовой
    if i=True then          // проверяем статус программы
    ...
    if (b=11) or (b=-1) then  // следим за количеством нажатий на данную кнопку
                 //при достижении максимума нажатий(12), счётчик обнуляем
    begin
